...
summary: You can make changes to your existing VCenter or ESXi host after you deploy Console local deployment.
---
...
[.lead]
In NetApp Console local deployment, you can make changes to your existing VCenter or ESXi host after you deploy the Console local deployment.
