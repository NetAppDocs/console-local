...
+ For example, you can verify that all agent services are running. link:task-troubleshoot-console-local.html#check-agent-status[Check the Console agent status^].
