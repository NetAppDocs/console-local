...
* link:task-maintain-console-local.html#connect-linux-host[Check the Console agent status (for Linux host deployments)]
...
== Validate that the Console agent meet requirements
Console agents require access to certain network endpoints, need to have several ports open, and must meet hardware requirements. You can validate that your Console agent meets these requirements from the Console or by using the agent maintenance console.
