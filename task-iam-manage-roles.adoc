...
You can assign access roles on a fleet or folder basis. For example, assign a role to a user for two specific fleets or assign the role at the folder level to give a user the Ransomware Resilience admin role for all fleets in a folder

NOTE: Add your folders and fleets before assigning users access. link:task-iam-manage-folders-fleets.html[Learn how to add folders and fleets.]
...
You can assign a user an access role for your organization, folder, or fleet. 
