...
== Fleet-level membership view

This page is member-centric. To view or modify access from a specific folder or fleet, use the fleet-centric task: link:task-users-fleets-assign.html[Manage fleet access assignments].
