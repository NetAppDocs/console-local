...
= Manage member access in NetApp Console (local)
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
====
.Directory users
Removing a user from your directory prevents that user from authenticating. You should also remove the user from your Console organization to keep the member list accurate and to remove any roles that were assigned in Console (local).
