...
For a detailed overview of the hierarchy and access model, see link:concept-folders-fleets-overview.html[Learn about folders and fleets in NetApp Console local deployment].
...
* To understand storage standards, see link:concept-storage-classes.html[Learn about storage classes and policies in NetApp Console local deployment].
* To create and manage fleets, see link:task-iam-manage-folders-fleets.html[Manage folders and fleets].
