...
summary: "Monitor the system health of NetApp Console (local deployment) to ensure all components are operating correctly."
---
= Monitor NetApp Console (local deployment) system health
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Monitor the NetApp Console (local deployment) system health to ensure all components are operating correctly and to identify issues before they affect your environment.
...
NetApp Console (local deployment) provides notifications to keep you informed about the health of your system. You can view these notifications in the Notification Center, which provides information about any issues that may arise with your system.
