...
Use the Workload Analyzer to view a single volume's behavior over time. You can investigate performance degradation, capacity trends, and resource contention issues.
...
* *From the Workload Analyzer page*: Select a volume and select *Analyze*. The analyzer opens with the volume pre-filled and a default time range of the last two hours.
