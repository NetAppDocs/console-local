...
summary: If you discovered your on-prem ONTAP cluster directly without using a Console agent, you can open the system in NetApp Console (local deployment) to manage the cluster by using ONTAP System Manager.
---

= Manage ONTAP clusters discovered directly in NetApp Console (local deployment)
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
