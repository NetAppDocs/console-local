...
= Monitor or audit user activity
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
If you need to monitor or audit an action that was completed related to identity and access, you can view details from the Audit page. For example, you might want to verify who added a member to an organization or that a fleet was deleted successfully.
