...
. If installing in a Government Cloud environment, disable the configuration checks. link:task-troubleshoot-console-local.html#disable-config-check[Learn how to disable configuration checks for manual installations.]
...
NOTE: If the installation fails, you can view the installation report and logs to help you fix the issues. link:task-troubleshoot-console-local.html#troubleshoot-installation[Learn how to troubleshoot installation issues.]
