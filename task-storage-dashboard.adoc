...
Monitoring the health of your storage estate helps you spot issues early and take action before they spread. Use the NetApp Console (local deployment) Home page to review the status of your backups and restores from NetApp Backup and Recovery, the workloads at risk for ransomware, and the workloads protected by NetApp Ransomware Resilience. You can also review storage capacity for individual clusters and Cloud Volumes ONTAP systems, ONTAP alerts, storage performance capacity, license status, and more.

Use this page as the entry point for the monitoring workflow. From here, you can move into additional dashboards, alerts, fleet health, and performance investigation.
...
+ 
If you already set up the NetApp Console (local deployment) and added at least one ONTAP cluster, the Home page shows metrics for your storage environment.
+
