---
permalink: performance-checker/legacy/concept_troubleshooting_workloads_using_workload_analyzer.html
sidebar: sidebar
keywords: workload analyzer, troubleshoot, legacy
summary: "Legacy reference for troubleshooting workloads with the Active IQ Unified Manager workload analyzer."
---
= Legacy: Troubleshoot workloads using the workload analyzer in Active IQ Unified Manager
:icons: font
:imagesdir: ../../media/
