---
permalink: performance-checker/legacy/concept_when_would_i_use_workload_analyzer.html
sidebar: sidebar
keywords: workload analyzer, use, legacy
summary: "Legacy reference for when to use the Active IQ Unified Manager workload analyzer."
---
= Legacy: When would I use the workload analyzer in Active IQ Unified Manager
:icons: font
:imagesdir: ../../media/
