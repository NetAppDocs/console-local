---
permalink: performance-checker/legacy/reference_what_data_does_workload_analyzer_display.html
sidebar: sidebar
keywords: workload analyzer, charts, display, data, legacy
summary: "Legacy reference for the data shown on the Active IQ Unified Manager workload analyzer page."
---
= Legacy: What data does the workload analyzer display in Active IQ Unified Manager
:icons: font
:imagesdir: ../../media/
