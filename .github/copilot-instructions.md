...
### What is NetApp Console (local deployment)?

NetApp Console (local deployment) unifies storage management and protection across both on-premises and cloud environments with integrated data services to protect and optimize data.
...
#### Product Name Usage
- **Product variants**: Use "NetApp Console" for the SaaS product and "NetApp Console (local deployment)" for the self-hosted option. Do not use these names interchangeably.
- **In headings**: Use "NetApp Console" without the article "the"
  - ✅ Correct: `= Learn about NetApp Console (local deployment) identity and access management`
  - ❌ Incorrect: `= Learn about the NetApp Console (local deployment) identity and access management`

- **In body text**: 
  - First reference: "NetApp Console (local deployment)" (capitalize "Console")
    - Example: "NetApp Console (local deployment) provides a web-based console and APIs for managing your storage resources..."
  - Subsequent references in the same file: Console (local deployment) (capitalize "Console")
  - Example: "Use NetApp Console (local deployment)'s Identity and Access Management (IAM) to organize your NetApp resources... Console (local deployment) provides access roles..." ("The" is capitalized here because it begins a new sentence)
