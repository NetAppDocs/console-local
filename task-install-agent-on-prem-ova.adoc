...
NOTE: If the deployment fails, you can access the validation report and logs from the NetApp Console (local deployment) host. link:task-troubleshoot-console-local.html#troubleshoot-installation[Learn how to troubleshoot installation issues.]
