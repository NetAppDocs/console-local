...
. Download the Console local deployment software from the link:https://mysupport.netapp.com/site/products/all/details/ncl/downloads-tab[NetApp Support Site^].
