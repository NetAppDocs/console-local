...
NetApp Console Local needs access to the networks where your ONTAP clusters and other resources are located. This allows the Console to discover those resources, monitor their health, and perform actions on them. If your agent doesn't have access to a target network, the Console won't be able to manage the resources on that network.
