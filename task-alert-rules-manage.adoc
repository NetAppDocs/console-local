...
* To deliver notifications by email, your Organization admin must configure an email server in the Console local deployment. To deliver notifications to an external system, your Organization admin must configure a webhook. link:task-console-configure-notifications-delivery.html[Learn how configuring webhooks].
