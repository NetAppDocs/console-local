...
link:concept-iam-rbac.html#role-inheritance[Learn more about how role-based access control and role inheritance work in NetApp Console local deployment].
