...
NOTE: Users with the Organization admin role can add resources to a folder to delegate fleet association tasks to the Folder or fleet admin for that folder. link:task-iam-manage-folders-fleets.html#associate-resource-folder[Associate a resource with a folder].
...
* If you associated the resource with a folder, a _Folder or fleet admin_ can now access the resource and associate it with a fleet within the folder. link:task-iam-manage-folders-fleets.html#associate-resource-folder[Associate a resource with a folder].
...
NOTE: To see which members have access to the resource, review the associated folder or fleet.

link:task-iam-users-fleets-assign.html[Manage fleet access assignments].
link:task-iam-manage-roles.html[Manage member access].
