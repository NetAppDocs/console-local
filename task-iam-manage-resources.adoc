...
A _resource_ is an entity that Console (local deployment) recognizes, such as a storage resource or a Backup and Recovery workload.

.Required access roles
You must have the _Super admin_, _Organization admin_, or _Folder or fleet admin_ role to manage resources in NetApp Console (local deployment). link:reference-iam-predefined-roles.html[Learn about access roles].
