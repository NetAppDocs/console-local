...
summary: Control user access to resources by adding them to fleets and folders in your NetApp Console local deployment organization. Grant access to users at the fleet level. 
---
...
NOTE: Users with the Organization admin role can add resources to a folder to delegate fleet association tasks to the Folder or fleet admin for that folder. link:task-iam-manage-folders-fleets.html#associate-resource-folder[Learn about associating a resource with a folder].
