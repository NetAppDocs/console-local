...
+
After you save the webhook, it is available for users to select where webhooks are supported such as Alert delivery options. link:task-alerts-create.html[Learn how to create alert rules and assign webhooks for alert delivery.]