...
keywords: inventory, fleet inventory, systems, volumes, capacity, security, performance, monitoring
summary: "Use inventory to monitor fleet health and investigate storage resources in NetApp Console local deployment."
---

= Monitor fleets using inventory
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Use inventory to monitor fleet health and investigate storage resources across your environment. Inventory provides capacity, security, and performance views that help you identify issues, understand resource utilization, and track managed storage systems.
