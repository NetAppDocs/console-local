...
---
= Workload Analyzer metrics in NetApp Console (local) (placeholder)
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
| QoS Limit Max
| The maximum latency ceiling defined by the QoS policy. When the latency line approaches or touches this line, ONTAP is throttling the workload.
...
* link:concept-workload-analyzer.html[Learn about NetApp Console (local) Workload Analyzer]
