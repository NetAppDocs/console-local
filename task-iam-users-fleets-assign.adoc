...
Console local deployment uses role-based access control (RBAC). A role that you assign at the folder level applies to all fleets and subfolders within that folder; a role that you assign at the fleet level applies only to that fleet's resources. link:concept-iam-rbac.html#role-inheritance[Learn about role inheritance in NetApp Console local deployment].
...
+
link:task-iam-manage-roles.html#remove-a-member-from-your-organization[Remove a member from your organization].
