...
When you're finished, either log out of the Console local deployment or move the slider back to return to read-only mode. The system removes your elevated permissions when your session expires.
