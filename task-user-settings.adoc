...
NOTE: If you need to sign in with a recovery code, use them in the order shown in the UI during the recovery-code prompt.
...
. Copy the generated recovery codes and save them in a secure location.
