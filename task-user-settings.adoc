...
Within the Console (local), each user has a profile that contains information about the user and their settings. You can view and edit your profile settings. 
...
You can only use your recovery code once. If you lose yours, create a new one.
