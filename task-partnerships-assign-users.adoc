...
. In the table, expand the respective row for organization, folder, or fleet where you want to view the member's assigned role and select the number in the *Role* column.
