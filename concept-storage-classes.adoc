...
* *Fleets:* Drift / Compliance (fleet-level view)
//<tsharp> You can monitor drift from the storage class page, not the Fleets.
* *Alerts:* Analyze (item-level triage)

For step-by-step instructions, see xref:remediate-storage-class-drift.adoc[Remediate storage class drift and performance non-compliance].
...
//<tsharp> the task-fleet-health-monitor topic doesn't exist, this link should point to the remediate drift topic.
