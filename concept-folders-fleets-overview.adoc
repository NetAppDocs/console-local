...
summary: "Learn how to use folders and storage fleets to organize resources and control access in NetApp Console (local deployment)."
---
...
+
users with the Org admin role can add new members to your organization. All users (including service accounts and Active Directory users) must be explicitly added and granted at least one role in order to access Console (local deployment).
...
* link:task-audit-console-activity.html[Monitor or audit Console (local deployment) actions]
